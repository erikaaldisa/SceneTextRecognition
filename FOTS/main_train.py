# python3 main_train.py --gpu_list='0' --learning_rate=0.01 --train_stage=2 --training_data_dir=training_images/ --training_gt_data_dir=training_labels/
...
tf.app.flags.DEFINE_string('pretrained_model_path', 'checkpoints/', '')
...
tf.app.flags.DEFINE_string('training_data_dir', default='training_images/', help='training images dir')
tf.app.flags.DEFINE_string('training_gt_data_dir', default='training_labels/', help='training gt dir')
